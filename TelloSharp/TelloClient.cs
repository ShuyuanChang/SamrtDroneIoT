...
namespace TelloSharp
{
    public class TelloClient : ITelloDevice
    {
        ...
        {
            await _telloUpdClient.SendActionAsync("command");
        ...
        {
            _telloUpdClient.SendActionAsync("command");
        ...
        {
            var result = await _telloUpdClient.SendAsync("command");
            result = await _telloUpdClient.SendAsync("battery?");
            int batteryLevel = 0;
        ...
        {
            var flightTime = await _telloUpdClient.SendAsync("command");
            flightTime = await _telloUpdClient.SendAsync("time?");
